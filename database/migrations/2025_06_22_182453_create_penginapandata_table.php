...
return new class extends Migration
{
    ...
    {
        Schema::create('penginapandata', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('harga_hotel_suite')->nullable();
            $table->string('harga_hotel_non_suite')->nullable();
            $table->string('harga_hotel_non_bintang')->nullable();
    ...
    {
        Schema::dropIfExists('penginapandata');
    }
};
