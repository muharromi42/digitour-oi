            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    <div class="card news-card h-100">
                        <img src="{{ asset('images/news1.jpg') }}" class="card-img-top" alt="News 1">
                        <div class="card-body">
                            <div class="news-date">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card news-card h-100">
                        <img src="{{ asset('images/news2.jpg') }}" class="card-img-top" alt="News 2">
                        <div class="card-body">
                            <div class="news-date">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card news-card h-100">
                        <img src="{{ asset('images/news3.jpg') }}" class="card-img-top" alt="News 3">
                        <div class="card-body">
                            <div class="news-date">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="gallery-item">
                        <img src="{{ asset('images/gallery1.jpg') }}" class="img-fluid rounded"
                            alt="Gallery Image 1">
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="gallery-item">
                        <img src="{{ asset('images/gallery2.jpg') }}" class="img-fluid rounded"
                            alt="Gallery Image 2">
                        <div class="gallery-overlay">
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="gallery-item">
                        <img src="{{ asset('images/gallery3.jpg') }}" class="img-fluid rounded"
                            alt="Gallery Image 3">
                        <div class="gallery-overlay">
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="gallery-item">
                        <img src="{{ asset('images/gallery4.jpg') }}" class="img-fluid rounded"
                            alt="Gallery Image 4">
                        <div class="gallery-overlay">
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="gallery-item">
                        <img src="{{ asset('images/gallery5.jpg') }}" class="img-fluid rounded"
                            alt="Gallery Image 5">
                        <div class="gallery-overlay">
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="gallery-item">
                        <img src="{{ asset('images/gallery6.jpg') }}" class="img-fluid rounded"
                            alt="Gallery Image 6">
                        <div class="gallery-overlay">
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="gallery-item">
                        <img src="{{ asset('images/gallery7.jpg') }}" class="img-fluid rounded"
                            alt="Gallery Image 7">
                        <div class="gallery-overlay">
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="gallery-item">
                        <img src="{{ asset('images/gallery8.jpg') }}" class="img-fluid rounded"
                            alt="Gallery Image 8">
                        <div class="gallery-overlay">
