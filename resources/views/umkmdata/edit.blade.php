...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('umkmdata.update', $umkmdata->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            @if ($errors->any())
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_komersial" name="nama_komersial"
                    placeholder="Nama Komersial Usaha" value="{{ old('nama_komersial', $umkmdata->nama_komersial) }}"
                    required>
            </div>
            ...
            <div class="mb-3">
                ...
                <select name="tematik_dtw[]" id="tematik_dtw" class="form-select" multiple>
                    <option value="Wisata Alam"
                        {{ in_array('Wisata Alam', old('tematik_dtw', json_decode($umkmdata->tematik_dtw, true) ?? [])) ? 'selected' : '' }}>
                        Wisata Alam</option>
                    <option value="Wisata Buatan"
                        {{ in_array('Wisata Buatan', old('tematik_dtw', json_decode($umkmdata->tematik_dtw, true) ?? [])) ? 'selected' : '' }}>
                        Wisata Buatan</option>
                    <option value="Wisata Budaya"
                        {{ in_array('Wisata Budaya', old('tematik_dtw', json_decode($umkmdata->tematik_dtw, true) ?? [])) ? 'selected' : '' }}>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_perusahaan" name="nama_perusahaan"
                    placeholder="Nama Perusahaan / Usaha" value="{{ old('nama_perusahaan', $umkmdata->nama_perusahaan) }}"
                    required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat lengkap"
                    value="{{ old('alamat', $umkmdata->alamat) }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nomor_telepon" name="nomor_telepon"
                    placeholder="Contoh: 08535412215" value="{{ old('nomor_telepon', $umkmdata->nomor_telepon) }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="tahun_mulai_beroperasi" name="tahun_mulai_beroperasi"
                    ...
                    value="{{ old('tahun_mulai_beroperasi', $umkmdata->tahun_mulai_beroperasi) }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="total_luas_area" name="total_luas_area"
                    placeholder="Total Luas Area" value="{{ old('total_luas_area', $umkmdata->total_luas_area) }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="luas_area_wisata" name="luas_area_wisata"
                    placeholder="Luas Area Wisata" value="{{ old('luas_area_wisata', $umkmdata->luas_area_wisata) }}">
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <input type="text" name="jam_buka" id="jam_buka" class="form-control"
                            placeholder="Jam Buka (Contoh: 08:00)" value="{{ old('jam_buka', $umkmdata->jam_buka) }}"
                            required>
                    </div>
                    <div class="col-md-6">
                        <input type="text" name="jam_tutup" id="jam_tutup" class="form-control"
                            placeholder="Jam Tutup (Contoh: 17:00)" value="{{ old('jam_tutup', $umkmdata->jam_tutup) }}"
                            required>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <input type="number" name="pengunjung_nusantara" id="pengunjung_nusantara" class="form-control"
                            ...
                            value="{{ old('pengunjung_nusantara', $umkmdata->pengunjung_nusantara) }}" min="0">
                    </div>
                    <div class="col-md-6">
                        <input type="number" name="pengunjung_mancanegara" id="pengunjung_mancanegara"
                            ...
                            value="{{ old('pengunjung_mancanegara', $umkmdata->pengunjung_mancanegara) }}"
                            min="0">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <input type="number" name="tiket_nusantara" class="form-control"
                            ...
                            value="{{ old('tiket_nusantara', $umkmdata->tiket_nusantara) }}" min="0">
                    </div>
                    <div class="col-md-6">
                        <input type="number" name="tiket_mancanegara" class="form-control"
                            placeholder="Wisatawan Mancanegara (Rp)"
                            value="{{ old('tiket_mancanegara', $umkmdata->tiket_mancanegara) }}" min="0">
                    </div>
                </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="durasi_kunjungan">
                    ...
                    <option value="24jam"
                        {{ old('durasi_kunjungan', $umkmdata->durasi_kunjungan) == '24jam' ? 'selected' : '' }}>24 jam
                    </option>
                    <option value=">1 jam s/d 6 jam"
                        {{ old('durasi_kunjungan', $umkmdata->durasi_kunjungan) == '>1 jam s/d 6 jam' ? 'selected' : '' }}>
                        &gt;1 jam s/d 6 jam</option>
                    <option value=">6 jam s/d 12 jam"
                        {{ old('durasi_kunjungan', $umkmdata->durasi_kunjungan) == '>6 jam s/d 12 jam' ? 'selected' : '' }}>
                        &gt;6 jam s/d 12 jam</option>
                    <option value=">12 jam s/d 18 jam"
                        {{ old('durasi_kunjungan', $umkmdata->durasi_kunjungan) == '>12 jam s/d 18 jam' ? 'selected' : '' }}>
                        &gt;12 jam s/d 18 jam</option>
                    <option value=">24 jam"
                        {{ old('durasi_kunjungan', $umkmdata->durasi_kunjungan) == '>24 jam' ? 'selected' : '' }}>&gt;24
                        jam
                    </option>
                </select>
            </div>
                ...
                <div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="dokumen_kapasitas" id="kapasitas_ada"
                            value="Ada Dokumen"
                            {{ old('dokumen_kapasitas', $umkmdata->dokumen_kapasitas) == 'Ada Dokumen' ? 'checked' : '' }}>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="dokumen_kapasitas" id="kapasitas_tidak"
                            ...
                            {{ old('dokumen_kapasitas', $umkmdata->dokumen_kapasitas) == 'Tidak Ada Dokumen' ? 'checked' : '' }}>
            ...
            <div class="mb-3">
                ...
                <input type="number" step="1" class="form-control" id="kapasitas_pengunjung"
                    ...
                    value="{{ old('kapasitas_pengunjung', $umkmdata->kapasitas_pengunjung) }}">
            ...
            <div class="mb-4">
                ...
                <select class="form-select" name="pendidikan_label" id="pendidikan_label">
                    <option value="" {{ !old('pendidikan_label', $umkmdata->pendidikan_label) ? 'selected' : '' }}
                        disabled>Pilih Jenjang Pendidikan</option>
                    <option value="SMA"
                        {{ old('pendidikan_label', $umkmdata->pendidikan_label) == 'SMA' ? 'selected' : '' }}>SMA
                    </option>
                    <option value="D3"
                        {{ old('pendidikan_label', $umkmdata->pendidikan_label) == 'D3' ? 'selected' : '' }}>D3</option>
                    <option value="S1"
                        {{ old('pendidikan_label', $umkmdata->pendidikan_label) == 'S1' ? 'selected' : '' }}>S1</option>
                    <option value="S2"
                        {{ old('pendidikan_label', $umkmdata->pendidikan_label) == 'S2' ? 'selected' : '' }}>S2</option>
                    <option value="S3"
                        {{ old('pendidikan_label', $umkmdata->pendidikan_label) == 'S3' ? 'selected' : '' }}>S3</option>
                    <option value="Lainnya"
                        {{ old('pendidikan_label', $umkmdata->pendidikan_label) == 'Lainnya' ? 'selected' : '' }}>Lainnya
                    </option>
                </select>
                <input type="number" class="form-control mt-2" name="jumlah_pendidikan" id="jumlah_pendidikan"
                    placeholder="Jumlah pekerja" value="{{ old('jumlah_pendidikan', $umkmdata->jumlah_pendidikan) }}">
            </div>
            ...
            <div class="mb-4">
                ...
                <select class="form-select" name="gender_label" id="gender_label">
                    <option value="" {{ !old('gender_label', $umkmdata->gender_label) ? 'selected' : '' }} disabled>
                        Pilih Jenis Kelamin</option>
                    <option value="Laki-laki"
                        {{ old('gender_label', $umkmdata->gender_label) == 'Laki-laki' ? 'selected' : '' }}>Laki-laki
                    </option>
                    <option value="Perempuan"
                        {{ old('gender_label', $umkmdata->gender_label) == 'Perempuan' ? 'selected' : '' }}>Perempuan
                    </option>
                    <option value="Lainnya"
                        {{ old('gender_label', $umkmdata->gender_label) == 'Lainnya' ? 'selected' : '' }}>Lainnya
                    </option>
                </select>
                <input type="number" class="form-control mt-2" name="jumlah_gender" id="jumlah_gender"
                    placeholder="Jumlah pekerja" value="{{ old('jumlah_gender', $umkmdata->jumlah_gender) }}">
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mt-2">
                                    <input type="number" class="form-control" name="pendapatan" id="pendapatan"
                                        ...
                                        value="{{ old('pendapatan', $umkmdata->pendapatan) }}" min="0"
                                        step="1000">
                                </div>
                                <div class="col-md-6 mt-2">
                                    <input type="number" class="form-control" name="pengeluaran" id="pengeluaran"
                                        placeholder="Pengeluaran (Rp)"
                                        value="{{ old('pengeluaran', $umkmdata->pengeluaran) }}" min="0"
                                        step="1000">
                                </div>
                            </div>
            ...
            <div class="form-group mt-4">
                ...
                <select name="museum_operasional[]" id="museum_operasional" class="form-select select2" multiple>
                    <option value="Peninggalan sejarah"
                        {{ in_array('Peninggalan sejarah', old('museum_operasional', json_decode($umkmdata->museum_operasional, true) ?? [])) ? 'selected' : '' }}>
                        Peninggalan sejarah</option>
                    <option value="Taman Budaya"
                        {{ in_array('Taman Budaya', old('museum_operasional', json_decode($umkmdata->museum_operasional, true) ?? [])) ? 'selected' : '' }}>
                        Taman Budaya</option>
                    <option value="Wisata Budaya Lainnya"
                        {{ in_array('Wisata Budaya Lainnya', old('museum_operasional', json_decode($umkmdata->museum_operasional, true) ?? [])) ? 'selected' : '' }}>
                        Wisata Budaya Lainnya</option>
                    <option value="Museum"
                        {{ in_array('Museum', old('museum_operasional', json_decode($umkmdata->museum_operasional, true) ?? [])) ? 'selected' : '' }}>
                        Museum</option>
                </select>
            ...
            <div class="form-group mt-4">
                ...
                <select name="aktivitas_alam[]" id="aktivitas_alam" class="form-select select2" multiple>
                    <option value="Taman Konservasi di Luar Habitat Alami (Ex-Situ)"
                        {{ in_array('Taman Konservasi di Luar Habitat Alami (Ex-Situ)', old('aktivitas_alam', json_decode($umkmdata->aktivitas_alam, true) ?? [])) ? 'selected' : '' }}>
                        Taman Konservasi di Luar Habitat Alami (Ex-Situ)</option>
                    <option value="Aktivitas Kawasan Alam Lainnya"
                        {{ in_array('Aktivitas Kawasan Alam Lainnya', old('aktivitas_alam', json_decode($umkmdata->aktivitas_alam, true) ?? [])) ? 'selected' : '' }}>
                        Aktivitas Kawasan Alam Lainnya</option>
                    <option value="Hutan Lindung"
                        {{ in_array('Hutan Lindung', old('aktivitas_alam', json_decode($umkmdata->aktivitas_alam, true) ?? [])) ? 'selected' : '' }}>
                        Hutan Lindung</option>
                    <option value="Kawasan Buru"
                        {{ in_array('Kawasan Buru', old('aktivitas_alam', json_decode($umkmdata->aktivitas_alam, true) ?? [])) ? 'selected' : '' }}>
                        Kawasan Buru</option>
                    <option value="Suaka Margasatwa & Cagar Alam"
                        {{ in_array('Suaka Margasatwa & Cagar Alam', old('aktivitas_alam', json_decode($umkmdata->aktivitas_alam, true) ?? [])) ? 'selected' : '' }}>
                        Suaka Margasatwa & Cagar Alam</option>
                    <option value="Taman Hutan Raya"
                        {{ in_array('Taman Hutan Raya', old('aktivitas_alam', json_decode($umkmdata->aktivitas_alam, true) ?? [])) ? 'selected' : '' }}>
                        Taman Hutan Raya</option>
                    <option value="Taman Konservasi"
                        {{ in_array('Taman Konservasi', old('aktivitas_alam', json_decode($umkmdata->aktivitas_alam, true) ?? [])) ? 'selected' : '' }}>
                        Taman Konservasi</option>
                    <option value="Taman Laut"
                        {{ in_array('Taman Laut', old('aktivitas_alam', json_decode($umkmdata->aktivitas_alam, true) ?? [])) ? 'selected' : '' }}>
                        Taman Laut</option>
                    <option value="Taman Nasional"
                        {{ in_array('Taman Nasional', old('aktivitas_alam', json_decode($umkmdata->aktivitas_alam, true) ?? [])) ? 'selected' : '' }}>
                        Taman Nasional</option>
                    <option value="Taman Wisata Alam"
                        {{ in_array('Taman Wisata Alam', old('aktivitas_alam', json_decode($umkmdata->aktivitas_alam, true) ?? [])) ? 'selected' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <select name="wisata_alam[]" id="wisata_alam" class="form-select select2" multiple>
                    <option value="Aktifitas Taman Bertema/Taman Hiburan"
                        {{ in_array('Aktifitas Taman Bertema/Taman Hiburan', old('wisata_alam', json_decode($umkmdata->wisata_alam, true) ?? [])) ? 'selected' : '' }}>
                        Aktifitas Taman Bertema/Taman Hiburan</option>
                    <option value="Pemandian Alam"
                        {{ in_array('Pemandian Alam', old('wisata_alam', json_decode($umkmdata->wisata_alam, true) ?? [])) ? 'selected' : '' }}>
                        Pemandian Alam</option>
                    <option value="Wisata Gua"
                        {{ in_array('Wisata Gua', old('wisata_alam', json_decode($umkmdata->wisata_alam, true) ?? [])) ? 'selected' : '' }}>
                        Wisata Gua</option>
                    <option value="Wisata Pantai"
                        {{ in_array('Wisata Pantai', old('wisata_alam', json_decode($umkmdata->wisata_alam, true) ?? [])) ? 'selected' : '' }}>
                        Wisata Pantai</option>
                    <option value="Wisata Petualangan Alam"
                        {{ in_array('Wisata Petualangan Alam', old('wisata_alam', json_decode($umkmdata->wisata_alam, true) ?? [])) ? 'selected' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <select name="wisata_buatan[]" id="wisata_buatan" class="form-select select2" multiple>
                    <option value="Daya Tarik Wisata Buatan / Binaan Manusia Lainnya"
                        {{ in_array('Daya Tarik Wisata Buatan / Binaan Manusia Lainnya', old('wisata_buatan', json_decode($umkmdata->wisata_buatan, true) ?? [])) ? 'selected' : '' }}>
                        Daya Tarik Wisata Buatan / Binaan Manusia Lainnya</option>
                    <option value="Kolam Pemancingan"
                        {{ in_array('Kolam Pemancingan', old('wisata_buatan', json_decode($umkmdata->wisata_buatan, true) ?? [])) ? 'selected' : '' }}>
                        Kolam Pemancingan</option>
                    <option value="Taman Rekreasi/Taman Wisata"
                        {{ in_array('Taman Rekreasi/Taman Wisata', old('wisata_buatan', json_decode($umkmdata->wisata_buatan, true) ?? [])) ? 'selected' : '' }}>
                        Taman Rekreasi/Taman Wisata</option>
                    <option value="Wisata Agro"
                        {{ in_array('Wisata Agro', old('wisata_buatan', json_decode($umkmdata->wisata_buatan, true) ?? [])) ? 'selected' : '' }}>
                        Wisata Agro</option>
                </select>
                <small class="form-text text-muted">*Dapat dipilih lebih dari satu</small>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <select name="wisata_tirta[]" id="wisata_tirta" class="form-select select2" multiple>
                    <option value="Aktivitas Wisata Air"
                        {{ in_array('Aktivitas Wisata Air', old('wisata_tirta', json_decode($umkmdata->wisata_tirta, true) ?? [])) ? 'selected' : '' }}>
                        Aktivitas Wisata Air</option>
                    <option value="Arung Jeram"
                        {{ in_array('Arung Jeram', old('wisata_tirta', json_decode($umkmdata->wisata_tirta, true) ?? [])) ? 'selected' : '' }}>
                        Arung Jeram</option>
                    <option value="Dermaga Marina"
                        {{ in_array('Dermaga Marina', old('wisata_tirta', json_decode($umkmdata->wisata_tirta, true) ?? [])) ? 'selected' : '' }}>
                        Dermaga Marina</option>
                    <option value="Kolam Pemancingan"
                        {{ in_array('Kolam Pemancingan', old('wisata_tirta', json_decode($umkmdata->wisata_tirta, true) ?? [])) ? 'selected' : '' }}>
                        Kolam Pemancingan</option>
                    <option value="Wisata Memancing"
                        {{ in_array('Wisata Memancing', old('wisata_tirta', json_decode($umkmdata->wisata_tirta, true) ?? [])) ? 'selected' : '' }}>
                        Wisata Memancing</option>
                    <option value="Wisata Selam"
                        {{ in_array('Wisata Selam', old('wisata_tirta', json_decode($umkmdata->wisata_tirta, true) ?? [])) ? 'selected' : '' }}>
                        Wisata Selam</option>
                    <option value="Wisata Tirta Lainnya"
                        {{ in_array('Wisata Tirta Lainnya', old('wisata_tirta', json_decode($umkmdata->wisata_tirta, true) ?? [])) ? 'selected' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <select name="hiburan_rekreasi[]" id="hiburan_rekreasi" class="form-select select2" multiple>
                    <option value="Aktifitas Hiburan & Rekreasi Lainnya"
                        {{ in_array('Aktifitas Hiburan & Rekreasi Lainnya', old('hiburan_rekreasi', json_decode($umkmdata->hiburan_rekreasi, true) ?? [])) ? 'selected' : '' }}>
                        Aktifitas Hiburan & Rekreasi Lainnya</option>
                    <option value="Usaha Arena Permainan"
                        {{ in_array('Usaha Arena Permainan', old('hiburan_rekreasi', json_decode($umkmdata->hiburan_rekreasi, true) ?? [])) ? 'selected' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <select name="metode_pemesanan[]" id="metode_pemesanan" class="form-select select2" multiple>
                    <option value="Langsung di Lokasi"
                        {{ in_array('Langsung di Lokasi', old('metode_pemesanan', json_decode($umkmdata->metode_pemesanan, true) ?? [])) ? 'selected' : '' }}>
                        Langsung di Lokasi</option>
                    <option value="Media Sosial"
                        {{ in_array('Media Sosial', old('metode_pemesanan', json_decode($umkmdata->metode_pemesanan, true) ?? [])) ? 'selected' : '' }}>
                        Media Sosial</option>
                    <option value="Pihak Ketiga :Traveloka/Tiket.com/dsb"
                        {{ in_array('Pihak Ketiga :Traveloka/Tiket.com/dsb', old('metode_pemesanan', json_decode($umkmdata->metode_pemesanan, true) ?? [])) ? 'selected' : '' }}>
                        Pihak Ketiga: Traveloka/Tiket.com/dsb</option>
                    <option value="Website"
                        {{ in_array('Website', old('metode_pemesanan', json_decode($umkmdata->metode_pemesanan, true) ?? [])) ? 'selected' : '' }}>
                        Website</option>
                </select>
                <small class="form-text text-muted">*Dapat dipilih lebih dari satu</small>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <input type="number" name="persentase_online" id="persentase_online" class="form-control"
                    placeholder="Contoh: 70" value="{{ old('persentase_online', $umkmdata->persentase_online) }}">
            ...
            <div class="form-group mt-4">
                ...
                <select name="metode_pembayaran[]" id="metode_pembayaran" class="form-select select2" multiple>
                    <option value="Debit : Tarnsfer/Q-Ris/EDC"
                        {{ in_array('Debit : Tarnsfer/Q-Ris/EDC', old('metode_pembayaran', json_decode($umkmdata->metode_pembayaran, true) ?? [])) ? 'selected' : '' }}>
                        Debit: Transfer / QRIS / EDC</option>
                    <option value="Kartu Kredit"
                        {{ in_array('Kartu Kredit', old('metode_pembayaran', json_decode($umkmdata->metode_pembayaran, true) ?? [])) ? 'selected' : '' }}>
                        Kartu Kredit</option>
                    <option value="Tunai"
                        {{ in_array('Tunai', old('metode_pembayaran', json_decode($umkmdata->metode_pembayaran, true) ?? [])) ? 'selected' : '' }}>
                        Tunai</option>
                </select>
                <small class="form-text text-muted">*Dapat dipilih lebih dari satu</small>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <select name="sarana_promosi[]" id="sarana_promosi" class="form-select select2" multiple>
                    <option value="Media Cetak : Koran/ Buletin/dsb"
                        {{ in_array('Media Cetak : Koran/ Buletin/dsb', old('sarana_promosi', json_decode($umkmdata->sarana_promosi, true) ?? [])) ? 'selected' : '' }}>
                        Media Cetak: Koran / Buletin / dsb</option>
                    <option value="Media Elektronik: Radio/Televisi/dsb"
                        {{ in_array('Media Elektronik: Radio/Televisi/dsb', old('sarana_promosi', json_decode($umkmdata->sarana_promosi, true) ?? [])) ? 'selected' : '' }}>
                        Media Elektronik: Radio / Televisi / dsb</option>
                    <option value="Media Sosial : Facebook/Youtube/Tiktok/dsb"
                        {{ in_array('Media Sosial : Facebook/Youtube/Tiktok/dsb', old('sarana_promosi', json_decode($umkmdata->sarana_promosi, true) ?? [])) ? 'selected' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <div class="form-check form-check-inline mt-2">
                    <input class="form-check-input" type="radio" name="paket_wisata" id="paket_wisata_ada"
                        value="Ada" {{ old('paket_wisata', $umkmdata->paket_wisata) == 'Ada' ? 'checked' : '' }}>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="paket_wisata" id="paket_wisata_tidak"
                        value="Tidak Ada"
                        {{ old('paket_wisata', $umkmdata->paket_wisata) == 'Tidak Ada' ? 'checked' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <input type="text" class="form-control mt-2" id="luas_area_parkir" name="luas_area_parkir"
                    placeholder="Contoh: 500" value="{{ old('luas_area_parkir', $umkmdata->luas_area_parkir) }}">
            ...
            <div class="form-group mt-4">
                ...
                <input type="number" step="1" class="form-control mt-2" id="kapasitas_motor"
                    ...
                    value="{{ old('kapasitas_motor', $umkmdata->kapasitas_motor) }}">
            ...
            <div class="form-group mt-4">
                ...
                <input type="number" step="1" class="form-control mt-2" id="kapasitas_mobil"
                    ...
                    value="{{ old('kapasitas_mobil', $umkmdata->kapasitas_mobil) }}">
                <small class="text-muted">*dalam unit</small>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <input type="number" step="1" class="form-control mt-2" id="kapasitas_bus" name="kapasitas_bus"
                    placeholder="Contoh: 10" value="{{ old('kapasitas_bus', $umkmdata->kapasitas_bus) }}">
                <small class="text-muted">*dalam unit</small>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <input type="number" step="1" class="form-control" id="jumlah_toilet_umum"
                    ...
                    value="{{ old('jumlah_toilet_umum', $umkmdata->jumlah_toilet_umum) }}">
                <small class="text-muted">*dalam unit</small>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="pembagian_toilet" id="pembagian_ada"
                        value="Ada"
                        {{ old('pembagian_toilet', $umkmdata->pembagian_toilet) == 'Ada' ? 'checked' : '' }}>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="pembagian_toilet" id="pembagian_tidak_ada"
                        value="Tidak Ada"
                        {{ old('pembagian_toilet', $umkmdata->pembagian_toilet) == 'Tidak Ada' ? 'checked' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="toilet_khusus" id="toilet_khusus_ada"
                        value="Ada" {{ old('toilet_khusus', $umkmdata->toilet_khusus) == 'Ada' ? 'checked' : '' }}>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="toilet_khusus" id="toilet_khusus_tidak_ada"
                        value="Tidak Ada"
                        {{ old('toilet_khusus', $umkmdata->toilet_khusus) == 'Tidak Ada' ? 'checked' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="prosedur_sop" id="prosedur_sop_ada"
                        value="Ada" {{ old('prosedur_sop', $umkmdata->prosedur_sop) == 'Ada' ? 'checked' : '' }}>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="prosedur_sop" id="prosedur_sop_tidak"
                        value="Tidak Ada"
                        {{ old('prosedur_sop', $umkmdata->prosedur_sop) == 'Tidak Ada' ? 'checked' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="sop_keamanan_pengunjung"
                        ...
                        {{ old('sop_keamanan_pengunjung', $umkmdata->sop_keamanan_pengunjung) == 'Ada' ? 'checked' : '' }}>
                    <label class="form-check-label" for="sop_keamanan_pengunjung_ada">Ada</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="sop_keamanan_pengunjung"
                        id="sop_keamanan_pengunjung_tidak" value="Tidak Ada"
                        {{ old('sop_keamanan_pengunjung', $umkmdata->sop_keamanan_pengunjung) == 'Tidak Ada' ? 'checked' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="jalur_evakuasi" id="jalur_evakuasi_ada"
                        value="Ada" {{ old('jalur_evakuasi', $umkmdata->jalur_evakuasi) == 'Ada' ? 'checked' : '' }}>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="jalur_evakuasi" id="jalur_evakuasi_tidak"
                        value="Tidak Ada"
                        {{ old('jalur_evakuasi', $umkmdata->jalur_evakuasi) == 'Tidak Ada' ? 'checked' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="asuransi_pengunjung"
                        ...
                        {{ old('asuransi_pengunjung', $umkmdata->asuransi_pengunjung) == 'Ada' ? 'checked' : '' }}>
                    <label class="form-check-label" for="asuransi_pengunjung_ada">Ada</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="asuransi_pengunjung"
                        id="asuransi_pengunjung_tidak" value="Tidak Ada"
                        {{ old('asuransi_pengunjung', $umkmdata->asuransi_pengunjung) == 'Tidak Ada' ? 'checked' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="pos_keamanan" id="pos_keamanan_ada"
                        value="Ada" {{ old('pos_keamanan', $umkmdata->pos_keamanan) == 'Ada' ? 'checked' : '' }}>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="pos_keamanan" id="pos_keamanan_tidak"
                        value="Tidak Ada"
                        {{ old('pos_keamanan', $umkmdata->pos_keamanan) == 'Tidak Ada' ? 'checked' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="kamera_cctv" id="kamera_cctv_ada"
                        value="Ada" {{ old('kamera_cctv', $umkmdata->kamera_cctv) == 'Ada' ? 'checked' : '' }}>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="kamera_cctv" id="kamera_cctv_tidak"
                        value="Tidak Ada"
                        {{ old('kamera_cctv', $umkmdata->kamera_cctv) == 'Tidak Ada' ? 'checked' : '' }}>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="foodservice" name="foodservice"
                    placeholder="foodservice" value="{{ old('foodservice', $umkmdata->foodservice) }}" required>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="signage" id="signage_ada" value="Ada"
                        {{ old('signage', $umkmdata->signage) == 'Ada' ? 'checked' : '' }}>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="signage" id="signage_tidak_ada"
                        value="Tidak Ada" {{ old('signage', $umkmdata->signage) == 'Tidak Ada' ? 'checked' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="pusat_informasi" id="pusat_informasi_ada"
                        value="Ada"
                        {{ old('pusat_informasi', $umkmdata->pusat_informasi) == 'Ada' ? 'checked' : '' }}>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="pusat_informasi" id="pusat_informasi_tidak"
                        value="Tidak Ada"
                        {{ old('pusat_informasi', $umkmdata->pusat_informasi) == 'Tidak Ada' ? 'checked' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="kotak_saran" id="kotak_saran_ada"
                        value="Ada" {{ old('kotak_saran', $umkmdata->kotak_saran) == 'Ada' ? 'checked' : '' }}>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="kotak_saran" id="kotak_saran_tidak"
                        value="Tidak Ada"
                        {{ old('kotak_saran', $umkmdata->kotak_saran) == 'Tidak Ada' ? 'checked' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="tempat_ibadah" id="tempat_ibadah_ada"
                        value="Ada" {{ old('tempat_ibadah', $umkmdata->tempat_ibadah) == 'Ada' ? 'checked' : '' }}>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="tempat_ibadah" id="tempat_ibadah_tidak"
                        value="Tidak Ada"
                        {{ old('tempat_ibadah', $umkmdata->tempat_ibadah) == 'Tidak Ada' ? 'checked' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="konsep_3r" id="konsep_3r_ada" value="Ada"
                        {{ old('konsep_3r', $umkmdata->konsep_3r) == 'Ada' ? 'checked' : '' }}>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="konsep_3r" id="konsep_3r_tidak"
                        value="Tidak Ada" {{ old('konsep_3r', $umkmdata->konsep_3r) == 'Tidak Ada' ? 'checked' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="sistem_pengolahan_limbah"
                        ...
                        {{ old('sistem_pengolahan_limbah', $umkmdata->sistem_pengolahan_limbah) == 'Ada' ? 'checked' : '' }}>
                    <label class="form-check-label" for="sistem_pengolahan_limbah_ada">Ada</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="sistem_pengolahan_limbah"
                        id="sistem_pengolahan_limbah_tidak" value="Tidak Ada"
                        {{ old('sistem_pengolahan_limbah', $umkmdata->sistem_pengolahan_limbah) == 'Tidak Ada' ? 'checked' : '' }}>
            ...
            <div class="form-group mt-4">
                ...
                <select name="sumberair[]" id="sumberair" class="form-select select2" multiple>
                    <option value="PDAM"
                        {{ in_array('PDAM', old('sumberair', is_array($umkmdata->sumberair ?? []) ? $umkmdata->sumberair : json_decode($umkmdata->sumberair ?? '[]', true))) ? 'selected' : '' }}>
                        PDAM
                    </option>
                    <option value="Pegunungan"
                        {{ in_array('Pegunungan', old('sumberair', is_array($umkmdata->sumberair ?? []) ? $umkmdata->sumberair : json_decode($umkmdata->sumberair ?? '[]', true))) ? 'selected' : '' }}>
                        Pegunungan
                    </option>
                    <option value="Sumur"
                        {{ in_array('Sumur', old('sumberair', is_array($umkmdata->sumberair ?? []) ? $umkmdata->sumberair : json_decode($umkmdata->sumberair ?? '[]', true))) ? 'selected' : '' }}>
                        Sumur
                    </option>
                    <option value="Lainnya"
                        {{ in_array('Lainnya', old('sumberair', is_array($umkmdata->sumberair ?? []) ? $umkmdata->sumberair : json_decode($umkmdata->sumberair ?? '[]', true))) ? 'selected' : '' }}>
                        Lainnya
                    </option>
                </select>
                <small class="form-text text-muted">*Dapat dipilih lebih dari satu</small>
