...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('umkmdata.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @if ($errors->any())
            ...
            {{-- Luas Area umkm --}}
            <div class="mb-3">
                <label for="luas_area_umkm" class="form-label">7. Luas Area untuk Kegiatan umkm (m²)</label>
                <input type="text" class="form-control" id="luas_area_umkm" name="luas_area_umkm"
                    placeholder="Luas Area umkm">
            </div>
            ...
            <div class="mb-3">
                <label class="form-label">10. Jenis Produk</label>
                <input type="text" class="form-control" id="jenis_produk" name="jenis_produk"
                    placeholder="jenis produk">
            </div>

            <div class="mb-3">
                <label class="form-label">11. harga Produk</label>
            ...
            <div class="form-group mt-4">
                <label class="form-label">
                    28. Ada/Tidaknya pusat oleh oleh masuk paket agen perjalanan
                </label>
            ...
            <a href="{{ route('umkmdata.index') }}" class="btn btn-secondary mt-3">Batal</a>
        </form>
    </div>
@endsection
