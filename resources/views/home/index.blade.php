 ...
 @section('content')
         ...
         <div class="container">
             <div class="row">
                 <div class="col-lg-6">
                     ...
                     <p>DIGITOUR (Digital Tourism and Culture Registry) adalah aplikasi pendataan wisata dan budaya berbasis
                         website
                         yang dikembangkan untuk Dinas Pariwisata Kabupaten Ogan Ilir. Aplikasi ini
                         bertujuan untuk mempermudah proses pendataan, pengelolaan, dan penyebaran
                         informasi mengenai destinasi wisata dan budaya daerah secara digital.</p>
                     {{-- <div class="mt-4">
     ...
     <!-- Contact Section -->
     <section class="contact-section py-5 bg-light d-flex align-items-center justify-content-center"
         style="min-height: 100vh;">
         <div class="container">
             <div class="row justify-content-center">
                 <div class="col-lg-6 text-center">
                     <h2 class="section-title">Contact Us</h2>
                     <div class="title-underline mb-4 mx-auto"
                         style="width: 80px; height: 3px; background-color: #007bff;"></div>
