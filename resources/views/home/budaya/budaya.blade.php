...
@section('content')
    ...
    <div class="position-relative">
        ...
        <div class="position-absolute top-50 start-50 translate-middle text-center text-white">
            <h1 class="display-4 fw-bold">Budaya</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}" class="text-white">Home</a></li>
                    <li class="breadcrumb-item active text-white" aria-current="page">Budaya</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container my-4">
        <form action="{{ route('home.budaya') }}" method="GET" class="row g-3 justify-content-center">
            <div class="col-md-3">
    ...
    <div class="container my-4">
            ...
            @forelse($budaya as $destination)
                <div class="col-lg-4 col-md-6">
                    <div class="card border-0 rounded-3 shadow-sm h-100">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">
                                <a href="{{ route('budaya.detail', $destination->id) }}"
        ...
        <div class="d-flex justify-content-center mt-4">
            {{ $budaya->appends(request()->query())->links() }}
        </div>
    </div>
