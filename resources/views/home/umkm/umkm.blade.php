...
@section('content')
    ...
    <div class="position-relative">
        ...
        <div class="position-absolute top-50 start-50 translate-middle text-center text-white">
            <h1 class="display-4 fw-bold">umkm</h1>
    ...
    <div class="container my-4">
        <form action="{{ route('home.umkm') }}" method="GET" class="row g-3 justify-content-center">
            <div class="col-md-3">
            ...
            @forelse($umkm as $destination)
                <div class="col-lg-4 col-md-6">
                    <div class="card border-0 rounded-3 shadow-sm h-100">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">
                                <a href="{{ route('umkm.detail', $destination->id) }}"
