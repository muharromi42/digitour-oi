    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <h1 class="blog-post-title">{{ $umkm->judul }}</h1>
                ...
                @if ($umkm->foto)
                    @php
                        ...
                        $fotoData = json_decode($umkm->foto);
                    ...
                    <div id="umkmCarousel" class="carousel slide mb-4" data-bs-ride="carousel">
                        ...
                        <div class="carousel-indicators">
                            @foreach ($fotoPaths as $index => $path)
                                <button type="button" data-bs-target="#umkmCarousel" data-bs-slide-to="{{ $index }}"
...
if (!str_contains($mapUrl, 'output=embed')) {
    ...
    if (str_contains($mapUrl, 'goo.gl/maps')) {
        // For shortened URLs, we'll need to create a generic embed
                ...
                <div class="mt-4 mb-4">
                    <a href="{{ route('home.umkm') }}" class="btn btn-secondary">Back to umkm List</a>
                </div>
            </div>
        </div>
    </div>
