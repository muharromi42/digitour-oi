            ...
            <div class="card-body">
                ...
                <form action="{{ route('umkm.update', $umkm->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="deskripsi" class="form-control" rows="4" required>{{ $umkm->deskripsi }}</textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="waktu_kunjungan" class="form-control"
                            value="{{ $umkm->waktu_kunjungan }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" name="map" class="form-control" value="{{ $umkm->map }}"
                        ...
                        @if ($umkm->foto)
                            <div class="mt-3">
                                ...
                                <div class="d-flex flex-wrap gap-3 edit-gallery">
                                    @foreach (json_decode($umkm->foto) as $index => $path)
