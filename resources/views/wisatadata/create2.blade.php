    ...
    <div class="container">
        ...
        <form action="{{ route('wisata.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mt-4">
                ...
                <div class="d-none mt-2" id="reason_parking_area_wrapper">
                    <input type="text" class="form-control" name="reason_parking_area" placeholder="Penjelasan">
                </div>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <div class="d-none mt-2" id="reason_motor_wrapper">
                    <input type="text" class="form-control" name="reason_motor" placeholder="Penjelasan">
                </div>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <div class="d-none mt-2" id="reason_mobil_wrapper">
                    <input type="text" class="form-control" name="reason_mobil" placeholder="Penjelasan">
                </div>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <div class="d-none mt-2" id="reason_bus_wrapper">
                    <input type="text" class="form-control" name="reason_bus" placeholder="Penjelasan">
                </div>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <div class="d-none mt-2" id="reason_toilet_umum_wrapper">
                    <input type="text" class="form-control" name="reason_toilet_umum" placeholder="Penjelasan">
                </div>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <div class="d-none mt-2" id="reason_pembagian_toilet_wrapper">
                    <input type="text" class="form-control" name="reason_pembagian_toilet" placeholder="Penjelasan">
                </div>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <div class="d-none mt-2" id="reason_toilet_khusus_wrapper">
                    <input type="text" class="form-control" name="reason_toilet_khusus" placeholder="Penjelasan">
                </div>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <div class="d-none mt-2" id="reason_prosedur_sop_wrapper">
                    <input type="text" class="form-control" name="reason_prosedur_sop" placeholder="Penjelasan">
                </div>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <div class="d-none mt-2" id="reason_sop_keamanan_pengunjung_wrapper">
                    <input type="text" class="form-control" name="reason_sop_keamanan_pengunjung"
            ...
            <div class="form-group mt-4">
                ...
                <div class="d-none mt-2" id="reason_jalur_evakuasi_wrapper">
                    <input type="text" class="form-control" name="reason_jalur_evakuasi" placeholder="Penjelasan">
                </div>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <div class="d-none mt-2" id="reason_asuransi_pengunjung_wrapper">
                    <input type="text" class="form-control" name="reason_asuransi_pengunjung"
                        placeholder="Penjelasan">
                </div>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <div class="d-none mt-2" id="reason_pos_keamanan_wrapper">
                    <input type="text" class="form-control" name="reason_pos_keamanan" placeholder="Penjelasan">
                </div>
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <div class="d-none mt-2" id="reason_kamera_cctv_wrapper">
                    <input type="text" class="form-control" name="reason_kamera_cctv" placeholder="Penjelasan">
                </div>
            </div>
